...
public class XemVeService extends RecyclerView.Adapter {
    ...
    public void setOnItemClickListener(FragmentVeHienTai.FragmentVeHienTai fragmentVeHienTai) {
    }

    public void set(FragmentVeHienTai.FragmentVeHienTai fragmentVeHienTai) {
    }
