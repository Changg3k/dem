...
import Service.XemVeService;
    ...
    public class FragmentVeHienTai extends Fragment implements XemVeService.OnItemClickListener {
        ...
        public View onCreateView(@NonNull LayoutInflater inflater,
            ...
            View rootView = inflater.inflate(R.layout.fragment_ve_hien_tai, container, false);

            // Khởi tạo Adapter
            xemVeService = new XemVeService(getContext());
            xemVeService.setOnItemClickListener(this);

            dsVe = new ArrayList<>();
            dsVe = xemVeService.getListVe();
            ...
            // ... Các phương thức và code khác ở đây ...
